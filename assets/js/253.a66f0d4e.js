...
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(35994);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(45449);
...
function getVariablesHint(cur, token, options) {
  ...
  if (kind === "StringValue" || kind === "NumberValue" || kind === "BooleanValue" || kind === "NullValue" || kind === "ListValue" && step === 1 || kind === "ObjectField" && step === 2 || kind === "Variable" && step === 2) {
    const namedInputType = typeInfo.type ? (0,graphql__WEBPACK_IMPORTED_MODULE_5__/* .getNamedType */ .MR)(typeInfo.type) : void 0;
    if (namedInputType instanceof graphql__WEBPACK_IMPORTED_MODULE_5__/* .GraphQLInputObjectType */ .zP) {
      return hintList(cur, token, [{ text: "{" }]);
    } else if (namedInputType instanceof graphql__WEBPACK_IMPORTED_MODULE_5__/* .GraphQLEnumType */ .Zb) {
    ...
    } else if (namedInputType === graphql__WEBPACK_IMPORTED_MODULE_6__/* .GraphQLBoolean */ .kk) {
      return hintList(cur, token, [
        { text: "true", type: graphql__WEBPACK_IMPORTED_MODULE_6__/* .GraphQLBoolean */ .kk, description: "Not false." },
        { text: "false", type: graphql__WEBPACK_IMPORTED_MODULE_6__/* .GraphQLBoolean */ .kk, description: "Not true." }
      ]);
    }
  }
}
...
function getTypeInfo(variableToType, tokenState) {
  ...
  (0,_forEachState_es_js__WEBPACK_IMPORTED_MODULE_1__.f)(tokenState, (state) => {
    if (state.kind === "Variable") {
      ...
      const nullableType = info.type ? (0,graphql__WEBPACK_IMPORTED_MODULE_5__/* .getNullableType */ .yl)(info.type) : void 0;
      info.type = nullableType instanceof graphql__WEBPACK_IMPORTED_MODULE_5__/* .GraphQLList */ .KT ? nullableType.ofType : null;
    } else if (state.kind === "ObjectValue") {
      const objectType = info.type ? (0,graphql__WEBPACK_IMPORTED_MODULE_5__/* .getNamedType */ .MR)(info.type) : void 0;
      info.fields = objectType instanceof graphql__WEBPACK_IMPORTED_MODULE_5__/* .GraphQLInputObjectType */ .zP ? objectType.getFields() : null;
