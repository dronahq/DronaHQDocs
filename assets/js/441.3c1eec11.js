...
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(10785);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(52433);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(20472);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(90316);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(30973);
  ...
  runOnlineParser(queryText, (_, state) => {
    if (state.kind === _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.FRAGMENT_DEFINITION && state.name && state.type) {
      fragmentDefs.push({
        ...
        name: {
          kind: graphql__WEBPACK_IMPORTED_MODULE_14__/* .Kind */ .h.NAME,
          value: state.name
        },
        selectionSet: {
...
function canUseDirective(state, directive) {
  ...
  switch (kind) {
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.QUERY:
      return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.QUERY) !== -1;
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.MUTATION:
      return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.MUTATION) !== -1;
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.SUBSCRIPTION:
      return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.SUBSCRIPTION) !== -1;
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.FIELD:
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.ALIASED_FIELD:
      return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.FIELD) !== -1;
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.FRAGMENT_DEFINITION:
      return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.FRAGMENT_DEFINITION) !== -1;
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.FRAGMENT_SPREAD:
      return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.FRAGMENT_SPREAD) !== -1;
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.INLINE_FRAGMENT:
      return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.INLINE_FRAGMENT) !== -1;
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.SCHEMA_DEF:
      return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.SCHEMA) !== -1;
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.SCALAR_DEF:
      return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.SCALAR) !== -1;
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.OBJECT_TYPE_DEF:
      return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.OBJECT) !== -1;
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.FIELD_DEF:
      return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.FIELD_DEFINITION) !== -1;
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.INTERFACE_DEF:
      return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.INTERFACE) !== -1;
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.UNION_DEF:
      return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.UNION) !== -1;
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.ENUM_DEF:
      return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.ENUM) !== -1;
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.ENUM_VALUE:
      return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.ENUM_VALUE) !== -1;
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.INPUT_DEF:
      return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.INPUT_OBJECT) !== -1;
    case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.INPUT_VALUE_DEF:
      ...
      switch (prevStateKind) {
        case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.ARGUMENTS_DEF:
          return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.ARGUMENT_DEFINITION) !== -1;
        case _index_es_js__WEBPACK_IMPORTED_MODULE_2__.R.INPUT_DEF:
          return locations.indexOf(graphql__WEBPACK_IMPORTED_MODULE_15__/* .DirectiveLocation */ .B.INPUT_FIELD_DEFINITION) !== -1;
      }
  }
  return false;
}
...
/* harmony export */ });
/* harmony import */ var _index_es_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4032);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(30973);
var __defProp = Object.defineProperty;
var __name = (target, value) => __defProp(target, "name", { value, configurable: true });
...
function onlineParser(options = {
  ...
  return {
    startState() {
      ...
      pushRule(options.parseRules, initialState, graphql__WEBPACK_IMPORTED_MODULE_1__/* .Kind */ .h.DOCUMENT);
      return initialState;
    },
    token(stream, state) {
