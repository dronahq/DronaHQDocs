...
var specifiedRules = __webpack_require__(23017);
...
var kinds = __webpack_require__(30973);
// EXTERNAL MODULE: ./node_modules/graphql/language/printer.mjs
var printer = __webpack_require__(39011);
  ...
  return {
    Field: function Field(node) {
      ...
      if (fieldDef && deprecationReason != null) {
        ...
        parentType != null || (0,invariant/* default */.Z)(0);
        context.reportError(new GraphQLError/* GraphQLError */._("The field ".concat(parentType.name, ".").concat(fieldDef.name, " is deprecated. ").concat(deprecationReason), node));
      }
    },
    Argument: function Argument(node) {
      ...
      if (argDef && deprecationReason != null) {
        ...
        if (directiveDef != null) {
          context.reportError(new GraphQLError/* GraphQLError */._("Directive \"@".concat(directiveDef.name, "\" argument \"").concat(argDef.name, "\" is deprecated. ").concat(deprecationReason), node));
        } else {
          var parentType = context.getParentType();
          var fieldDef = context.getFieldDef();
          parentType != null && fieldDef != null || (0,invariant/* default */.Z)(0);
          context.reportError(new GraphQLError/* GraphQLError */._("Field \"".concat(parentType.name, ".").concat(fieldDef.name, "\" argument \"").concat(argDef.name, "\" is deprecated. ").concat(deprecationReason), node));
        }
      }
    },
    ObjectField: function ObjectField(node) {
      var inputObjectDef = (0,definition/* getNamedType */.xC)(context.getParentInputType());
      ...
      if ((0,definition/* isInputObjectType */.hL)(inputObjectDef)) {
        ...
        if (deprecationReason != null) {
          context.reportError(new GraphQLError/* GraphQLError */._("The input field ".concat(inputObjectDef.name, ".").concat(inputFieldDef.name, " is deprecated. ").concat(deprecationReason), node));
        }
      }
    },
    EnumValue: function EnumValue(node) {
      ...
      if (enumValueDef && deprecationReason != null) {
        var enumTypeDef = (0,definition/* getNamedType */.xC)(context.getInputType());
        enumTypeDef != null || (0,invariant/* default */.Z)(0);
        context.reportError(new GraphQLError/* GraphQLError */._("The enum value \"".concat(enumTypeDef.name, ".").concat(enumValueDef.name, "\" is deprecated. ").concat(deprecationReason), node));
      }
    }
  };
}
...
var onlineParser_es = __webpack_require__(98007);
...
function getDiagnostics(query, schema = null, customRules, isRelayCompatMode, externalFragments) {
  ...
  try {
    ...
    if (error instanceof GraphQLError/* GraphQLError */._) {
...
function validateQuery(ast, schema = null, customRules, isRelayCompatMode) {
  ...
  const deprecationWarningAnnotations = mapCat((0,validate/* validate */.Gu)(schema, ast, [NoDeprecatedCustomRule]), (error) => annotations(error, DIAGNOSTIC_SEVERITY.Warning, "Deprecation"));
