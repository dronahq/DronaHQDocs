...
/* harmony export */ });
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(35994);
/* harmony import */ var _introspection_es_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(87331);
/* harmony import */ var _forEachState_es_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(27437);
  ...
  (0,_forEachState_es_js__WEBPACK_IMPORTED_MODULE_1__.f)(tokenState, (state) => {
    ...
    switch (state.kind) {
      ...
      case "AliasedField":
        ...
        break;
      case "SelectionSet":
        info.parentType = info.type ? (0,graphql__WEBPACK_IMPORTED_MODULE_2__/* .getNamedType */ .MR)(info.type) : null;
        break;
      case "Directive":
      ...
      case "Argument":
        ...
        break;
      case "EnumValue":
        const enumType = info.inputType ? (0,graphql__WEBPACK_IMPORTED_MODULE_2__/* .getNamedType */ .MR)(info.inputType) : null;
        info.enumValue = enumType instanceof graphql__WEBPACK_IMPORTED_MODULE_2__/* .GraphQLEnumType */ .Zb ? find(enumType.getValues(), (val) => val.value === state.name) : null;
        break;
      case "ListValue":
        const nullableType = info.inputType ? (0,graphql__WEBPACK_IMPORTED_MODULE_2__/* .getNullableType */ .yl)(info.inputType) : null;
        info.inputType = nullableType instanceof graphql__WEBPACK_IMPORTED_MODULE_2__/* .GraphQLList */ .KT ? nullableType.ofType : null;
        break;
      case "ObjectValue":
        const objectType = info.inputType ? (0,graphql__WEBPACK_IMPORTED_MODULE_2__/* .getNamedType */ .MR)(info.inputType) : null;
        info.objectFieldDefs = objectType instanceof graphql__WEBPACK_IMPORTED_MODULE_2__/* .GraphQLInputObjectType */ .zP ? objectType.getFields() : null;
        break;
      case "ObjectField":
...
function getFieldDef(schema, type, fieldName) {
  ...
  if (fieldName === _introspection_es_js__WEBPACK_IMPORTED_MODULE_0__.a.name && (0,graphql__WEBPACK_IMPORTED_MODULE_2__/* .isCompositeType */ .ML)(type)) {
...
function getEnumValueReference(typeInfo) {
  return {
    ...
    type: typeInfo.inputType ? (0,graphql__WEBPACK_IMPORTED_MODULE_2__/* .getNamedType */ .MR)(typeInfo.inputType) : void 0
  };
}
...
/* harmony import */ var _index_es_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(35195);
...
/* harmony import */ var _codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(43338);
/* harmony import */ var _SchemaReference_es_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(89654);
/* harmony import */ var _info_addon_es_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(46681);
/* harmony import */ var _index_es_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(35195);
...
/* harmony import */ var _introspection_es_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(87331);
/* harmony import */ var _forEachState_es_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(27437);
var __defProp = Object.defineProperty;
var __name = (target, value) => __defProp(target, "name", { value, configurable: true });
...
function renderType(into, typeInfo, options, t) {
  if (t instanceof graphql__WEBPACK_IMPORTED_MODULE_8__/* .GraphQLNonNull */ .Gc) {
    renderType(into, typeInfo, options, t.ofType);
    text(into, "!");
  } else if (t instanceof graphql__WEBPACK_IMPORTED_MODULE_8__/* .GraphQLList */ .KT) {
    text(into, "[");
    renderType(into, typeInfo, options, t.ofType);
    text(into, "]");
  } else {
