  ...
  return {
    Field: function Field(node) {
      ...
      if (fieldDef && deprecationReason != null) {
        ...
        parentType != null || (0,invariant/* default */.A)(0);
        context.reportError(new GraphQLError/* GraphQLError */.e("The field ".concat(parentType.name, ".").concat(fieldDef.name, " is deprecated. ").concat(deprecationReason), node));
      }
    },
    Argument: function Argument(node) {
      ...
      if (argDef && deprecationReason != null) {
        ...
        if (directiveDef != null) {
          context.reportError(new GraphQLError/* GraphQLError */.e("Directive \"@".concat(directiveDef.name, "\" argument \"").concat(argDef.name, "\" is deprecated. ").concat(deprecationReason), node));
        } else {
          var parentType = context.getParentType();
          var fieldDef = context.getFieldDef();
          parentType != null && fieldDef != null || (0,invariant/* default */.A)(0);
          context.reportError(new GraphQLError/* GraphQLError */.e("Field \"".concat(parentType.name, ".").concat(fieldDef.name, "\" argument \"").concat(argDef.name, "\" is deprecated. ").concat(deprecationReason), node));
        }
      }
    },
    ObjectField: function ObjectField(node) {
      var inputObjectDef = (0,definition/* getNamedType */.MR)(context.getParentInputType());

      if ((0,definition/* isInputObjectType */.qK)(inputObjectDef)) {
        ...
        if (deprecationReason != null) {
          context.reportError(new GraphQLError/* GraphQLError */.e("The input field ".concat(inputObjectDef.name, ".").concat(inputFieldDef.name, " is deprecated. ").concat(deprecationReason), node));
        }
      }
    },
    EnumValue: function EnumValue(node) {
      ...
      if (enumValueDef && deprecationReason != null) {
        var enumTypeDef = (0,definition/* getNamedType */.MR)(context.getInputType());
        enumTypeDef != null || (0,invariant/* default */.A)(0);
        context.reportError(new GraphQLError/* GraphQLError */.e("The enum value \"".concat(enumTypeDef.name, ".").concat(enumValueDef.name, "\" is deprecated. ").concat(deprecationReason), node));
      }
    }
  };
}
...
var index_es = __webpack_require__(35195);
// EXTERNAL MODULE: ./node_modules/@graphiql/react/dist/Range.es.js
var Range_es = __webpack_require__(4601);
// EXTERNAL MODULE: ./node_modules/@graphiql/react/dist/onlineParser.es.js
var onlineParser_es = __webpack_require__(59920);
...
const specifiedSDLRules = [
  LoneSchemaDefinitionRule/* LoneSchemaDefinitionRule */.l,
  UniqueOperationTypesRule/* UniqueOperationTypesRule */.u,
  UniqueTypeNamesRule/* UniqueTypeNamesRule */.i,
  UniqueEnumValueNamesRule/* UniqueEnumValueNamesRule */.g,
  UniqueFieldDefinitionNamesRule/* UniqueFieldDefinitionNamesRule */.X,
  UniqueDirectiveNamesRule/* UniqueDirectiveNamesRule */.Z,
  KnownTypeNamesRule/* KnownTypeNamesRule */.y,
  KnownDirectivesRule/* KnownDirectivesRule */.e,
  UniqueDirectivesPerLocationRule/* UniqueDirectivesPerLocationRule */.U,
  PossibleTypeExtensionsRule/* PossibleTypeExtensionsRule */.S,
  UniqueArgumentNamesRule/* UniqueArgumentNamesRule */.J,
  UniqueInputFieldNamesRule/* UniqueInputFieldNamesRule */.C
];
function validateWithCustomRules(schema, ast, customRules, isRelayCompatMode, isSchemaDocument) {
  const rules = specifiedRules/* specifiedRules */.g.filter((rule) => {
    if (rule === NoUnusedFragmentsRule/* NoUnusedFragmentsRule */.z || rule === ExecutableDefinitionsRule/* ExecutableDefinitionsRule */.T) {
      return false;
    }
    if (isRelayCompatMode && rule === KnownFragmentNamesRule/* KnownFragmentNamesRule */.K) {
      return false;
    }
    return true;
  });
  ...
  const errors = (0,validate/* validate */.tf)(schema, ast, rules);
  return errors.filter((error) => {
    if (error.message.indexOf("Unknown directive") !== -1 && error.nodes) {
      const node = error.nodes[0];
      if (node && node.kind === kinds/* Kind */.b.DIRECTIVE) {
  ...
  if (externalFragments) {
    if (typeof externalFragments === "string") {
      ...
      query += "\n\n" + externalFragments.reduce((agg, node) => {
        agg += (0,printer/* print */.y)(node) + "\n\n";
        return agg;
      }, "");
    }
  }
  try {
    ast = (0,parser/* parse */.qg)(query);
  } catch (error) {
    if (error instanceof GraphQLError/* GraphQLError */.e) {
...
function validateQuery(ast, schema = null, customRules, isRelayCompatMode) {
  ...
  const deprecationWarningAnnotations = mapCat((0,validate/* validate */.tf)(schema, ast, [NoDeprecatedCustomRule]), (error) => annotations(error, DIAGNOSTIC_SEVERITY.Warning, "Deprecation"));
...
function getRange(location, queryText) {
  const parser = (0,onlineParser_es.o)();
